DROP TABLE IF EXISTS `meta_report_template`;
CREATE TABLE `meta_report_template` (
  ...
  `paramListInfo` text DEFAULT null comment '参数设置',
  `columnListInfo` text DEFAULT  null comment '列设置',
  PRIMARY KEY (`id`),
